...
"""
# A layer-2 Forwarding component that uses the information from the SlicedNet module to forward packets in the respective slice.
#Layer 2 Learning switch code on POX
...
class LearningSwitch (object):
  def __init__ (self, connection, transparent):
    ...
    # Our table
    self.macToPort = {}
    self.switchPorts = core.SlicedNet.portTable(dpid = dpid_to_str(self.connection.dpid))
  ...
  def _handle_PacketIn (self, event):
    ...
    if packet.dst.is_multicast:
      ...
      if packet.dst not in self.macToPort: # 4
        ...
        msg.idle_timeout = 10
        msg.hard_timeout = 30
	if msg.match.tp_src == 5002 or msg.match.tp_dst == 5002:
